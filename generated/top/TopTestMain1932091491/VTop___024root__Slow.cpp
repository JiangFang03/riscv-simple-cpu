...
void VTop___024root___settle__TOP__3(VTop___024root* vlSelf) {
    ...
    __Vtemp5[0U] = ((IData)(vlSelf->Top__DOT__imm_gen__DOT__u_imm_64) 
                    << 0xcU);
    __Vtemp5[1U] = (((IData)(vlSelf->Top__DOT__imm_gen__DOT__u_imm_64) 
                     >> 0x14U) | ((IData)((vlSelf->Top__DOT__imm_gen__DOT__u_imm_64 
                                           >> 0x20U)) 
                                  << 0xcU));
    __Vtemp5[2U] = ((IData)((vlSelf->Top__DOT__imm_gen__DOT__u_imm_64 
                             >> 0x20U)) >> 0x14U);
    VL_EXTEND_WW(79,76, __Vtemp6, __Vtemp5);
    __Vtemp7[0U] = ((IData)(vlSelf->Top__DOT__imm_gen__DOT__u_imm_64) 
                    << 0xcU);
    __Vtemp7[1U] = (((IData)(vlSelf->Top__DOT__imm_gen__DOT__u_imm_64) 
                     >> 0x14U) | ((IData)((vlSelf->Top__DOT__imm_gen__DOT__u_imm_64 
                                           >> 0x20U)) 
                                  << 0xcU));
    __Vtemp7[2U] = ((IData)((vlSelf->Top__DOT__imm_gen__DOT__u_imm_64 
                             >> 0x20U)) >> 0x14U);
    VL_EXTEND_WW(79,76, __Vtemp8, __Vtemp7);
...
void VTop___024root___ctor_var_reset(VTop___024root* vlSelf) {
    ...
    vlSelf->Top__DOT__imm_gen_io_i_imm = VL_RAND_RESET_Q(64);
    ...
    vlSelf->Top__DOT__imm_gen__DOT__u_imm_64 = VL_RAND_RESET_Q(64);
    for (int __Vi0=0; __Vi0<1024; ++__Vi0) {
