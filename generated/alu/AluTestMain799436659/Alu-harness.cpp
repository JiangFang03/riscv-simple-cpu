...
class Alu_api_t: public sim_api_t<VerilatorDataWrapper*> {
    ...
    void init_sim_data() {
        ...
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_aluCtrl)));
        sim_data.inputs.push_back(new VerilatorQData(&(dut->io_oper_b)));
        sim_data.inputs.push_back(new VerilatorQData(&(dut->io_oper_a)));
        sim_data.outputs.push_back(new VerilatorCData(&(dut->io_zero)));
        sim_data.outputs.push_back(new VerilatorQData(&(dut->io_result)));
...
int main(int argc, char **argv, char **env) {
    ...
    VAlu* top = new VAlu;
    std::string vcdfile = "./generated/alu/AluTestMain799436659/Alu.vcd";
