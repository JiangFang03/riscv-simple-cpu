...
#endif
#include <iostream>
class InstMem_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    InstMem_api_t(VInstMem* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["InstMem.reset"] = 0;
    }
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    VInstMem* top = new VInstMem;
    std::string vcdfile = "./generated/im/InstMemTestMain1717935061/InstMem.vcd";
